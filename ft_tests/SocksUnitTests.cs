...
public class SocksUnitTests
{
    ...
    private static (Thread A, Thread B) StartDualDynamicTunnel(string aDynamicArgs, string bDynamicArgs, string writeFilename, string readFilename)
    {
    ...
    private static void RunDynamicForwardTransfer(string dynamicArg, int socksPort, byte version, bool useHostname, int destPort)
    {
        var writeFilename = Path.GetTempFileName();
        var readFilename = Path.GetTempFileName();
    ...
    private static (Thread Listen, Thread Forward) StartTunnel(string dynamicArg, string writeFilename, string readFilename)
    {
    ...
    private static TcpClient ConnectSocks(byte version, int socksPort, string host, int port)
    {
