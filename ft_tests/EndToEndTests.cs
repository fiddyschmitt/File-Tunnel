...
{
    private const string WIN_X64_EXE = @"R:\Temp\ft release\win-x64\ft.exe";
    private const string LINUX_X64_EXE = @"R:\Temp\ft release\linux-x64\ft";
    ...
    private const string DEV_BOX_IP = "192.168.0.31";
    private const int SOCKS_PROXY_PORT = 5005;
    private const int SOCKS_HTTP_PORT = 5007;
    private const int SOCKS_UDP_PORT = 5008;
    ...
    private const int STRESS_A_LOCAL = 5301, STRESS_A_REMOTE = 5302, STRESS_B_LOCAL = 5303, STRESS_B_REMOTE = 5304, STRESS_HTTP_PORT = 5305;
    private const int STRESS_PAYLOAD_BYTES = 32 * 1024 * 1024;

    private static string localWindowsOutputFilename = "";

    private static ProcessRunner win10_x64_1;
    private static ProcessRunner win10_x64_2;
    private static ProcessRunner win10_x64_3;


    private static ProcessRunner linux_x64_1;
    private static ProcessRunner linux_x64_2;
    private static ProcessRunner linux_x64_3;
    ...
    private static string? dropboxRefreshToken;
    ...
    private static string? win10Username;
    private static string? win10Password;

    private static CsvWriter csvWriter;

    private static int testNumber = 0;
    private static readonly Stopwatch totalDuration = new();
    private static double totalCpuUsageMs = 0;
    ...
    private static void RunSocksChecks(Client side1, Client side2, CancellationToken ct)
    {
    ...
    private static void Retry(string what, int deadlineSeconds, CancellationToken ct, Func<bool> check)
    {
    ...
    private static IDisposable StartHttpResponder(int port, string marker, CancellationToken ct)
    {
    ...
    private static IDisposable StartUdpEcho(int port, CancellationToken ct)
    {
    ...
    private static void RunSocksStress(Client side1, Client side2, CancellationToken ct)
    {
    ...
    private static IDisposable StartLargePayloadHttpServer(int port, int payloadBytes, CancellationToken ct)
    {
        var listener = new TcpListener(IPAddress.Any, port);
        listener.Start();
