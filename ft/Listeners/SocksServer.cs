...
public class SocksServer : StreamEstablisher
{
    ...
    private readonly ConcurrentDictionary<SocksUdpAssociation, byte> associations = new();
    ...
    private void HandleUdpAssociate(TcpClient client, Stream controlStream, SocksRequest request)
    {
