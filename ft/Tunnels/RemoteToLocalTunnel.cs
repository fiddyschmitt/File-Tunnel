...
public class RemoteToLocalTunnel
{
    ...
    private void ProvideRemoteForwardsToCounterpart()
    {
    ...
    private void SendConnectResultIfPossible(System.IO.Stream stream, ConnectStatus status)
    {
    ...
    private static ConnectStatus MapSocketError(SocketException? socketException) => socketException?.SocketErrorCode switch
    {
